...
<html>
  <head>
    ...
    <title>Classificação | <?php include('../dist/includes/title.php');?></title>
				  ...
				  <div class="row">
					 <div class="col-md-12">
						  ...
						  <div class="form-group">
							<label for="date">Adicionar Classificação</label><br>
				...
				<div id="form">
				  ...
				  <div class="row">
					 <div class="col-md-12">
						  ...
						  <div class="form-group">
							<label for="date">Alterar Classificação</label><br>
